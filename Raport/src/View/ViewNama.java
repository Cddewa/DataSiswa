...
public class ViewNama extends javax.swing.JFrame {

    /**
     * Creates new form ViewNama
     */
    public ViewNama() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Masukkan Nama Siswa :");
    ...
    private void okeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okeActionPerformed
        ...
        if(!nama.equals("")){
            ...
            dispose();
            new ViewTiapSiswa(name).setVisible(true);
        }
        else{
            JOptionPane.showMessageDialog(null, "Nama Tdk Boleh Kosong");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewNama.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
